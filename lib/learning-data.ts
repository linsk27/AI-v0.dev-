    ...
    weeks: [
      {
        ...
        tasks: [
          { id: 'w1d1', day: 1, title: 'Python 文件操作 + json 处理', practice: '读写 JSON 配置，异常 try-except', output: '脚本：读取/写入日志文件', completed: false },
          { id: 'w1d2', day: 2, title: '异步 aiohttp + 并发请求', practice: '用 aiohttp 并发调用公共 API', output: '脚本：批量请求+统计耗时', completed: false },
          { id: 'w1d3', day: 3, title: 'FastAPI 基础：GET/POST', practice: '写一个简单的 /echo 和 /add 接口', output: '本地运行 Swagger 文档', completed: false },
          ...
          { id: 'w1d6', day: 6, title: 'Git 分支管理 + PR 模拟', practice: '创建 dev 分支，修改代码后合并到 main', output: '仓库有清晰 commit 历史', completed: false },
      ...
      },
      {
        ...
        tasks: [
          { id: 'w2d1', day: 1, title: '大模型 API 调用（非流式）', practice: '用 requests 调用 DeepSeek', output: '脚本：固定 prompt 返回 JSON', completed: false },
          { id: 'w2d2', day: 2, title: '流式输出 + 参数调优', practice: '实现流式打印回复', output: '命令行聊天机器人（单轮）', completed: false },
          { id: 'w2d3', day: 3, title: 'Prompt 工程：Few-shot、CoT', practice: '让模型做数学推理、按 JSON 格式输出', output: '脚本：自动提取文本中的实体', completed: false },
      ...
      },
      {
        ...
        tasks: [
          { id: 'w3d1', day: 1, title: 'Embedding 原理 + 向量数据库选型', practice: '安装 Chroma，跑通官方示例', output: '理解相似度检索流程', completed: false },
          { id: 'w3d2', day: 2, title: '文档切片', practice: '把 PDF 或 Word 转成 txt，切分成块', output: '输出 chunks（json 文件）', completed: false },
      ...
      },
      {
        ...
        tasks: [
          ...
          { id: 'w4d2', day: 2, title: '写 Dockerfile + requirements.txt', practice: '让 FastAPI 应用能在容器内运行', output: '本地 docker build -t rag-app .', completed: false },
          { id: 'w4d3', day: 3, title: 'Docker Compose', practice: '用 compose 启动 app + chroma', output: '一键启动脚本', completed: false },
          { id: 'w4d4', day: 4, title: '私有化部署概念（本地 ollama）', practice: '安装 ollama，跑一个 qwen 小模型', output: '本地模型替代 API 调用', completed: false },
    ...
    weeks: [
      {
        ...
        tasks: [
          { id: 'w5d1', day: 1, title: 'Agent 核心概念（ReAct）', practice: '跑通 create_react_agent 官方示例', output: '输出简单的 Agent 日志', completed: false },
          { id: 'w5d2', day: 2, title: 'Tool 基础：计算器、当前时间', practice: '给 Agent 加两个工具，测试问答', output: 'Agent 能回答数学/时间问题', completed: false },
          { id: 'w5d3', day: 3, title: '联网搜索工具', practice: 'Agent 根据问题决定是否搜索', output: '支持"今天广州天气"类问题', completed: false },
      ...
      },
      {
        ...
        tasks: [
          ...
          { id: 'w6d3', day: 3, title: '上下文压缩', practice: '使用 ConversationSummaryMemory', output: '压缩历史后还能理解意图', completed: false },
          { id: 'w6d4', day: 4, title: '防幻觉：强制调用工具', practice: '要求 Agent 必须查询工具后再回答', output: '减少编造事实', completed: false },
          { id: 'w6d5', day: 5, title: '多 Agent 分工', practice: '写手 Agent + 审阅 Agent 协作写文档', output: '两个 Agent 接力完成', completed: false },
      ...
      },
      {
        ...
        tasks: [
          ...
          { id: 'w7d2', day: 2, title: '异常兜底 + 重试机制', practice: 'API 调用失败时自动重试 3 次', output: '提高鲁棒性', completed: false },
          ...
          { id: 'w7d5', day: 5, title: '项目性能分析', practice: '优化 chunk 数量，使用缓存', output: '响应时间减少 30%', completed: false },
          { id: 'w7d6', day: 6, title: '完善项目文档', practice: '架构图（Mermaid）、部署视频', output: 'GitHub 满星项目结构', completed: false },
          { id: 'w7d7', day: 7, title: '双项目整合', practice: 'Agent 可以调用 RAG 知识库', output: '端到端智能助手', completed: false },
        ]
      },
      {
        id: 'week-8',
        ...
        tasks: [
          { id: 'w8d1', day: 1, title: '安装 Unity Hub + 编辑器', practice: '创建 3D 项目，了解场景、物体、脚本', output: '能移动一个方块', completed: false },
          { id: 'w8d2', day: 2, title: 'C# 基础 + 按钮事件', practice: '写一个按钮，点击打印日志', output: '简单的 UI 交互', completed: false },
          { id: 'w8d3', day: 3, title: 'Unity 中发送 HTTP 请求', practice: '调用之前写的聊天 API', output: '控制台输出 AI 回复', completed: false },
          { id: 'w8d4', day: 4, title: '整合：NPC 对话功能', practice: '点击 NPC -> 弹出对话框 -> 调用 AI', output: 'NPC 能回答用户输入', completed: false },
          { id: 'w8d5', day: 5, title: '给 NPC 添加"性格" Prompt', practice: '修改 system prompt', output: '角色扮演 NPC', completed: false },
    ...
    weeks: [
      {
        ...
        tasks: [
          ...
          { id: 'w9d3', day: 3, title: '修复项目 bug', practice: '每个项目再跑一遍', output: '确保零错误启动', completed: false },
          { id: 'w9d4', day: 4, title: '优化项目注释', practice: '添加详细注释', output: '代码可读性提升', completed: false },
      ...
      },
      {
        ...
        weekOutput: '面试知识储备完成',
        tasks: [
          { id: 'w10d1', day: 1, title: 'RAG 原理 + 幻觉解决方案', practice: '背诵 + 理解', output: '能清晰讲解', completed: false },
          { id: 'w10d2', day: 2, title: '向量数据库对比', practice: 'Chroma vs Milvus', output: '能对比优缺点', completed: false },
          { id: 'w10d3', day: 3, title: 'Agent 工具调用流程', practice: 'ReAct 模式详解', output: '能画流程图', completed: false },
          { id: 'w10d4', day: 4, title: '大模型 API 优化', practice: '流式、批处理、缓存', output: '能举例说明', completed: false },
          { id: 'w10d5', day: 5, title: '部署流程', practice: 'Docker、Ollama、云服务', output: '能演示部署', completed: false },
          { id: 'w10d6', day: 6, title: '后端基础', practice: '并发、GIL、FastAPI 生命周期', output: '能解答常见问题', completed: false },
          { id: 'w10d7', day: 7, title: 'LeetCode 刷题', practice: '数组、字符串、哈希', output: '完成 20 道简单题', completed: false },
        ]
      },
      {
        id: 'week-11',
        ...
        tasks: [
          ...
          { id: 'w11d4', day: 4, title: 'GitHub 仓库美化', practice: '架构图、演示 GIF', output: 'README 专业化', completed: false },
      ...
      },
      {
        ...
        tasks: [
          { id: 'w12d1', day: 1, title: '自我讲解项目架构', practice: '录音回听', output: '30 分钟模拟', completed: false },
          { id: 'w12d2', day: 2, title: '讲解项目难点', practice: '录音回听', output: '30 分钟模拟', completed: false },
          { id: 'w12d3', day: 3, title: '讲解项目优化点', practice: '录音回听', output: '30 分钟模拟', completed: false },
          { id: 'w12d4', day: 4, title: '同学模拟面试', practice: '重点深挖 RAG', output: '反馈改进', completed: false },
          { id: 'w12d5', day: 5, title: '学长模拟面试', practice: '重点深挖 Agent', output: '反馈改进', completed: false },
  ...
  children: [
    {
      ...
      label: '基础能力',
      children: [
        { id: 'python', label: 'Python 编程' },
        { id: 'fastapi', label: 'FastAPI 后端' },
        { id: 'git', label: 'Git 协作' },
    ...
    },
    {
      ...
      children: [
        { id: 'api', label: 'API 调用' },
        { id: 'prompt', label: 'Prompt 工程' },
        { id: 'stream', label: '流式输出' },
        { id: 'memory', label: '上下文记忆' }
      ]
    },
    {
      id: 'rag',
      label: 'RAG 系统',
      children: [
        { id: 'embedding', label: 'Embedding 向量化' },
        { id: 'vectordb', label: '向量数据库' },
        { id: 'retrieval', label: '检索策略' },
        { id: 'generation', label: '生成优化' }
      ]
    },
    {
      id: 'agent',
    ...
    },
    {
      ...
      children: [
        { id: 'async', label: '异步并发' },
        { id: 'retry', label: '重试机制' },
        { id: 'logging', label: '日志追踪' },
        { id: 'deploy', label: '私有化部署' }
      ]
    }
  ]
}
